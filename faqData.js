...
// //           <img src="https://via.placeholder.com/300x150?text=Start+Your+Journey" alt="Start Your Journey" style="border-radius:8px;">
// //         </div>
// //       `,
// //       followUp: ["How can I apply for a study abroad program?"],
// //     },
// //     {
// //       question: "How can I apply for a study abroad program?",
// //       answer: `
// //         <p>You can easily apply by:</p>
// //         <ul class="list-disc pl-5">
// //           <li>Booking a counseling session with our expert advisors.</li>
// //           <li>Getting assistance with documentation, including SOP, LORs, and transcripts.</li>
// //           <li>Receiving guidance on application timelines and requirements.</li>
// //         </ul>
...
// //       answer: `
// //         <p><strong>Your choice is limitless!</strong></p>
...
// //         </ul>
// //         <div style="background:#f7f7f7; padding:10px; border-radius:5px; margin-top:10px;">
// //           <p><em>Tip:</em> List down your preferred countries and let our counselors help you select the best match!</p>
// //         </div>
// //       `,
...
// //               <td style="border: 1px solid #ccc; padding: 8px;">Top-ranked universities, research opportunities, diverse culture.</td>
// //             </tr>
// //             <tr>
// //               <td style="border: 1px solid #ccc; padding: 8px;">Germany</td>
// //               <td style="border: 1px solid #ccc; padding: 8px;">Affordable education, strong engineering and technology programs.</td>
// //             </tr>
// //             <tr>
// //               <td style="border: 1px solid #ccc; padding: 8px;">Australia</td>
// //               <td style="border: 1px solid #ccc; padding: 8px;">Vibrant campuses, excellent research facilities, post-study work options.</td>
// //             </tr>
// //             <tr>
// //               <td style="border: 1px solid #ccc; padding: 8px;">UK</td>
// //               <td style="border: 1px solid #ccc; padding: 8px;">Historic institutions, global networking, scholarship opportunities.</td>
// //             </tr>
// //           </tbody>
// //         </table>
// //       `,
...
// //           <img src="https://via.placeholder.com/250x150?text=Our+Services" alt="Our Services" style="border-radius:8px;">
// //         </div>
// //       `,
// //       followUp: [],
// //     },
...
// //       answer: `
// //         <p>The duration of the visa process depends on various factors including the destination country and individual circumstances. Typically:</p>
// //         <ul class="list-disc pl-5">
...
// //         <ul class="list-disc pl-5">
// //           <li>Guidance on work permit regulations</li>
// //           <li>Assistance in securing internships and part-time roles</li>
// //           <li>Support for post-study work visa applications</li>
// //         </ul>
// //       `,
// //       followUp: [],
// //     },
...
// //       answer: `
// //         <p>The overall cost varies widely based on the country, university, and program you choose. Factors include:</p>
// //         <ul class="list-disc pl-5">
// //           <li><strong>Tuition Fees:</strong> Can range from economical public university rates to premium private institution fees.</li>
// //           <li><strong>Living Expenses:</strong> Vary by city and country.</li>
// //           <li><strong>Additional Costs:</strong> Such as travel, insurance, and personal expenses.</li>
// //         </ul>
// //         <p>We help you find budget-friendly options, scholarship opportunities, and financial aid to make your dream achievable.</p>
// //       `,
// //       followUp: [],
// //     },
// //     {
...
// //           <li>PTE Academic</li>
// //         </ul>
// //         <p>If you need help preparing for these tests, we offer resources and guidance to help you achieve the scores required.</p>
// //       `,
// //       followUp: [],
// //     },
// //     {
...
// //           <li>Submit your application and prepare for any interviews or biometric submissions.</li>
// //         </ol>
...
// //           <li>Career counseling and post-study guidance for seamless transition into the workforce</li>
// //         </ul>
// //         <div style="text-align:center; margin-top:10px;">
// //           <img src="https://via.placeholder.com/250x150?text=Job+Placement+Support" alt="Job Placement" style="border-radius:8px;">
// //         </div>
// //       `,
...
// //       answer: `
// //         <p>Our career counseling services are designed to help you:</p>
// //         <ul class="list-disc pl-5">
// //           <li>Identify your strengths and career goals</li>
// //           <li>Explore in-demand career paths and industries</li>
// //           <li>Receive personalized advice on upskilling and networking</li>
// //         </ul>
// //         <p>We ensure that every step is aligned with both your academic and professional ambitions.</p>
// //       `,
// //       followUp: [],
// //     },
// //     {
// //       question: "What steps are involved in the 2-stage counseling process?",
// //       answer: `
// //         <p>Our unique 2-stage counseling process includes:</p>
// //         <ol class="list-decimal pl-5">
// //           <li><strong>Initial Consultation:</strong> We discuss your aspirations, academic background, and career goals to map out a potential pathway.</li>
// //           <li><strong>Personalized Guidance:</strong> Based on your profile, we create a customized roadmap including university selection, application strategy, and visa process.</li>
// //         </ol>
// //         <p>This approach ensures a comprehensive understanding and a tailored action plan just for you.</p>
// //       `,
// //       followUp: [],
// //     },
// //     {
...
// //           <li>Explain why you are a perfect fit for your chosen program.</li>
// //         </ul>
...
// //     },
// //     {
// //       question: "What kind of cultural experiences can I expect abroad?",
// //       answer: `
// //         <p>Studying abroad is not just about academics—it’s about living a new culture. Here’s what you can look forward to:</p>
// //         <ul class="list-disc pl-5">
// //           <li>Immersive local cultural events and festivals</li>
// //           <li>Opportunities to learn new languages and customs</li>
// //           <li>Building a global network of friends and professionals</li>
// //         </ul>
// //         <p>Our pre-departure sessions prepare you for a seamless cultural transition, ensuring you make the most of your international experience.</p>
// //       `,
// //       followUp: [],
// //     },
// //   ],
...
//           </ul>
//           <div class="flex justify-center mt-4">
//             <img src="https://via.placeholder.com/250x150?text=Job+Placement+Support" alt="Job Placement" class="rounded-lg max-w-full">
//           </div>
//         </div>
//       `,
//       followUp: ["What kind of career counseling do you offer?"],
